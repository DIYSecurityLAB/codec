...
const Supporters: React.FC<SupportersProps> = ({ className = "" }) => {
  const supporters = [
    ...
    {
      name: "Troféus e Medalhas Globo",
      logo: "/trofeu-e-medalhas-globo.jpeg",
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Instituições e organizações que acreditam no desenvolvimento das
            artes marciais como ferramenta de transformação social
          </p>
        </div>
        ...
        <div className="text-center bg-white rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200">
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-base sm:text-lg text-gray-600 mb-6 leading-relaxed">
              Junte-se a nós na missão de promover o desenvolvimento das artes
              marciais como ferramenta de educação, inclusão social e formação
              de cidadãos mais conscientes e preparados.
            </p>
